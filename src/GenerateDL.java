...
String pkg1=pkg.replaceAll("\\.",File.separator);
this.fullPath=this.fullPath+File.separator+classname+File.separator+"src"+File.separator+pkg1;
...
String fullPath=this.fullPath+File.separator+"dl"+File.separator+classname+File.separator+"exceptions";
...
String fileName=fullPath+File.separator+className+".java";
...
String fullPath=this.fullPath+File.separator+"dl"+File.separator+classname+File.separator+"interfaces";
try
{
File file=new File(fullPath);
if(file.exists()==false)
...
String fullPath=this.fullPath+File.separator+"dl"+File.separator+classname;
try
{
File file=new File(fullPath);
if(file.exists()==false)
...
String fullPath=this.fullPath+File.separator+"dl"+File.separator+classname;
File file=new File(fullPath);
String fileName=""+fullPath+File.separator+"BuildConnection.java";
